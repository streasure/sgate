...
set GO_OPT=Mmessage.proto=github.com/streasure/sgate/protobuf,Mgame.proto=github.com/streasure/sgate/protobuf,Muser.proto=github.com/streasure/sgate/protobuf,Mgateway.proto=github.com/streasure/sgate/protobuf,Mpush.proto=github.com/streasure/sgate/protobuf
...
"%PROTOC_PATH%" --go_out=paths=source_relative:. --go_opt=%GO_OPT% --plugin=protoc-gen-go=%PROTOC_GEN_GO% push.proto
if %errorlevel% neq 0 (echo Error: push.proto failed & exit /b 1)
